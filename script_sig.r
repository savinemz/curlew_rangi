...
shp_loc <- st_union(shp_loc_1,l_shp$forest_clairseme)
shp_loc <- st_union(shp_loc,l_shp$mudflat)
l_shp$reef  <-  st_difference(l_shp$reef_buffer,shp_loc)


shp_loc <- st_union(shp_loc_1,l_shp$mudflat)
l_shp$clairseme  <-  st_difference(l_shp$clairseme,shp_loc )


shp_loc <- st_union(l_shp$reef_buffer,l_shp$forest_dense)
shp_loc <- st_union(shp_loc,l_shp$clairseme)
